...
void LitWavesApp::Update(const GameTimer& gt)
{
	...
	// Cycle throgh the circle frame resource array.
...
void LitWavesApp::BuildRootSignature()
{
	...
	CD3DX12_ROOT_SIGNATURE_DESC rootSigDesc(3, slotRootParameters, 0, nullptr, D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT);
